...
export const URL: string = "https://www.cartrawler.com/ctabe/cars.json";

export const STATIC_API_RESPONSE: ResponseInterface[] = [
  {
    VehAvailRSCore: {
      VehRentalCore: {
...
export const explanations = {
  orSimilar:
    "Please note that car make and model are not guaranteed. The vehicle displayed is an example of the car class for the given offer.",
};
